...
export const Icons = {
  ...
  github: (props: IconProps) => (
    <svg viewBox="0 0 24 24" fill="currentColor" overflow="visible" {...props}>
      <g style={{ transform: "scale(1.3)", transformOrigin: "center" }}>
  ...
  // ✨ FIX: Scaled up by 1.2 from the center and allowed to overflow its rectangular viewBox
  ...
  instagram: (props: IconProps) => (
    <svg viewBox="0 0 24 24" fill="currentColor" overflow="visible" {...props}>
      <g style={{ transform: "scale(1.15)", transformOrigin: "center" }}>
